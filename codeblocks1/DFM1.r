...
data1 <- read.csv("C:/Users/Administrator/desktop/codeblocks1/Processed_datasets/Datasets_WithSC.csv",header = T,check.names = F)
...
feature_index <- read.csv('C:/Users/Administrator/desktop/codeblocks1/Processed_datasets/feature_index.csv',fileEncoding = "gbk",header = F,stringsAsFactors = F)
...
print(index_fitted)
write.table(t(index_fitted) , 'C:/Users/Administrator/desktop/codeblocks1/Processed_datasets/Index_ch_fitted.csv',col.names = F,row.names = F,sep = ',')
